...
import { getPosOrders, type PosOrdersData, type PosTransaction } from '../_lib/pos-api';
...
export default function PosOrdersPage() {
  ...
  useEffect(() => { getPosOrders().then(setData); }, []);
            ...
            <div className="divide-y divide-slate-50">
              {visible.map(tx => (
                <div
                  ...
                  className="grid grid-cols-[1fr_auto_auto_auto_auto_auto] items-center px-6 py-4 transition-colors hover:bg-slate-50/60"
                >
                  <div>
